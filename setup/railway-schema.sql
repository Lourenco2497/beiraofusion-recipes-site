...
CREATE TABLE IF NOT EXISTS `recipes` (
  ...
  CONSTRAINT `fk_recipes_category_recipe1`
    ...
    REFERENCES `category_recipe` (`category_recipe_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `ingredients` (
  ...
  CONSTRAINT `fk_ingredients_category_ingredients1`
    ...
    REFERENCES `category_ingredients` (`category_ingredients_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- Table `vouchers_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vouchers_type` (
...
CREATE TABLE IF NOT EXISTS `vouchers` (
  ...
  CONSTRAINT `fk_vouchers_vouchers_type1`
    ...
    REFERENCES `vouchers_type` (`vouchers_type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `vouchers_users` (
  ...
  CONSTRAINT `fk_vouchers_has_users_vouchers1`
    ...
    REFERENCES `vouchers` (`vouchers_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
